...
function renderShell() {
  ...
  app.innerHTML = `
    <aside class="sidebar" aria-label="Навигация">
      <a href="#" class="brand" data-action="catalog" aria-label="Alem — каталог задач"><span class="brand-symbol">a</span><span>alem<span class="brand-dot">.</span></span></a>
    ...
    <div class="workspace">
      ...
      <footer class="page-footer"><span>alem. <span class="footer-separator">/</span> От идеи к общему результату</span><button class="text-button" data-action="rating">Прозрачный рейтинг ${icon('arrowUp')}</button></footer>
    </div>`;
